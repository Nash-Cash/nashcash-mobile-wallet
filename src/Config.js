...
const Config = new function() {
     ...
     */
    this.coinName = 'NashCash';

    /**
     * Prefix for URI encoded addresses
     */
    this.uriPrefix = 'nashcash://';
     ...
     */
    this.devFeePercentage = 0.00001;

    /**
     * Address to send dev fee to
     */
    this.devFeeAddress = 'NaCaSVe1VQee8h9bg4PHugZ1wQBre5Yoyj8oteRwFnVqKeiR7HSmzRuCZ73yVZPKbGPwWqffpmdP5XvqsQjDqsRE4Aqg6opDZU';
     ...
     */
    this.priceApiLink = 'https://api.coingecko.com/api/v3/simple/price?ids=nashcash&vs_currencies=usd';

    /**
     * Default daemon to use. Can either be a BlockchainCacheApi(baseURL, SSL),
     * or a ConventionalDaemon(url, port).
     */
    this.defaultDaemon = new Daemon('api.nashcash.net', 443);
     ...
     */
    this.appName = 'NashCash';

    /**
     * Slogan phrase during wallet CreateScreen
     */
    this.sloganCreateScreen = 'welcome to NashCash mobile';
     ...
     */
    this.explorerBaseURL = 'http://explorer.nashcash.net/index.html?hash=';
     ...
     */
    this.nodeListURL = 'https://api.nashcash.net/node/list';
};
